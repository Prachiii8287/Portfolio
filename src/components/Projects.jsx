...
const projects = [
  {
    title: "ExplainMyMoney",
    description: "ExplainMyMoney is an OCR-driven finance tool that extracts data from statements and receipts while automatically masking personally identifiable information, making it safe to share and analyze financial documents.",
    // TODO: replace with a real screenshot once the UI is further along
    image: "/images/explainmymoneyimg.png",
    github: "https://github.com/Prachiii8287/ExplainMyMoney",
    live: "https://explainmymoney-production.up.railway.app/", // add once deployed
    tags: ["Django", "React", "PostgreSQL", "OCR"],
    status: "In Progress"
  },
  {
    title: "EcoEats",
    ...
    github: "https://github.com/Prachiii8287/EcoEats",
    live: "https://imaginative-mandazi-dd0178.netlify.app/",
    tags: ["HTML", "Tailwind Css", "Web3","Javascript","Blockchain","Smart Contracts","Solidity","Ethereum","Ethers.js"]
  },
  {
    title: "SEEMA",
    description: "SEEMA (Solar Energy Equity Management Application) is a decentralized platform that enables solar panel owners to monetize surplus energy using blockchain-based Urja tokens, promoting clean energy access and equity.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              {project.status && (
                <div className="absolute top-4 right-4 z-10 px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full text-xs text-white/90 border border-white/20">
                  {project.status}
                </div>
              )}
